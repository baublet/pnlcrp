 ...
 *
 * $Id: gpl.txt 17801 2008-08-05 23:10:49Z JensT $
 */
?>
<?php
/* 
...
/* Constants */
$gallery->app->galleryTitle = "Visual Archive";
$gallery->app->useIcons = "no";
$gallery->app->skinname = "none";
$gallery->app->uploadMode = "form";
$gallery->app->albumDir = "/hw00/d58/labhist/strike/gallery/albums";
$gallery->app->tmpDir = "/tmp";
$gallery->app->photoAlbumURL = "http://depts.washington.edu/labhist/strike/gallery";
$gallery->app->albumDirURL = "http://depts.washington.edu/labhist/strike/gallery/albums";
$gallery->app->movieThumbnail = "/nfs/aesop13/hw00/d58/labhist/strike/gallery/images/movie.thumb.jpg";
...
$gallery->app->highlightJpegImageQuality = "90";
$gallery->app->thumbJpegImageQuality = "90";
// optional <i>geeklog_dir</i> missing
$gallery->app->albumTreeDepth = "0";
$gallery->app->microTree = "no";
$gallery->app->highlight_size = "300";
...
$gallery->app->gallery_thumb_frame_style = "solid";
...
$gallery->app->smtpFromHost = "depts.washington.edu";
...
$gallery->app->userDir = "/hw00/d58/labhist/strike/gallery/albums/.users";

/* Defaults */
$gallery->app->default["cols"] = "3";
$gallery->app->default["rows"] = "10";
$gallery->app->default["bordercolor"] = "black";
$gallery->app->default["border"] = "1";
$gallery->app->default["font"] = "Georgia";
$gallery->app->default["thumb_size"] = "300";
$gallery->app->default["thumb_ratio"] = "0";
$gallery->app->default["resize_size"] = "0";
...
$gallery->app->default["returnto"] = "no";
...
$gallery->app->default["nav_thumbs"] = "yes";
