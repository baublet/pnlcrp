...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return /******/ (function(modules) {
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var Compiler =
          ...
          (function(_Obj) {
            ...
            _proto._compileExpression = function _compileExpression(
              node,
              frame
            ) {
            ...
            _proto.compileFilterAsync = function compileFilterAsync(
              node,
              frame
            ) {
              var name = node.name;
            ...
            _proto.compileKeywordArgs = function compileKeywordArgs(
              node,
              frame
            ) {
            ...
            _proto.compileRoot = function compileRoot(node, frame) {
              ...
              blocks.forEach(function(block, i) {
                ...
                if (blockNames.indexOf(name) !== -1) {
                  throw new Error(
                    'Block "' + name + '" defined more than once.'
                  );
                }
        ...
        var Parser =
          ...
          (function(_Obj) {
            ...
            _proto.parseCall = function parseCall() {
              ...
              var callerArgs =
                this.parseSignature(true) || new nodes.NodeList();
     ...
     */
            ...
            _proto.parseSignature = function parseSignature(
              tolerant,
              noParens
            ) {
              var tok = this.peekToken();
              ...
              if (this.in_code) {
                ...
                if (this.isFinished()) {
                  ...
                  if (lib.indexOf(complexOps, curComplex) !== -1) {
                    ...
                    if (
                      lib.indexOf(complexOps, curComplex + this.current()) !==
                      -1
                    ) {
